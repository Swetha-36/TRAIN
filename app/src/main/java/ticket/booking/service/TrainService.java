...
public class TrainService {
    ...
    public TrainService() throws IOException {
        ...
        trainList = objectMapper.readValue(trains, new TypeReference<List<Trains>>() {});
    }
    ...
    public void addTrain(Trains newTrain) {
        ...
        Optional<Trains> existingTrain = trainList.stream()
    ...
    public void updateTrain(Trains updatedTrain) {
    ...
    private boolean validTrain(Trains train, String source, String destination) {
